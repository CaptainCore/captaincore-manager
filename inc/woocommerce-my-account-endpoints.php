...
class CaptainCore_My_Account_Health_Endpoint {
	...
	public function new_menu_items( $items ) {
		...
		// Insert your custom endpoint.
		$items[ self::$endpoint ] = __( 'Health', 'woocommerce' );
	 ...
	 */
	public function endpoint_content() {
		wc_get_template( '../woocommerce/myaccount/health-endpoint.php' );
	}
...
// Flush rewrite rules on plugin activation.
register_activation_hook( __FILE__, array( 'CaptainCore_My_Account_Health_Endpoint', 'install' ) );
