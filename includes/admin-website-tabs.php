...
<?php if ( defined( "CONSTELLIX_API_KEY" ) and defined( "CONSTELLIX_SECRET_KEY" ) ) { ?><a class="nav-tab dashicons-before dashicons-welcome-widgets-menus<?php if( $screen->post_type == "captcore_domain") { echo " nav-tab-active"; } ?>" href="/wp-admin/edit.php?post_type=captcore_domain"><span>Domains</span></a><?php } ?>
