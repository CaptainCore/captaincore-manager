...
class Component extends DCLogic {
  ...
  computeBilling(s) {
    ...
    return {
      ...
      // Billing details block inside the card dialog (billing.js owns the live
      // version) — a card cannot be added without a complete address.
      cardAddrForm: false, cardAddrDone: true, cardAddrEdit: () => {},
      cardAddrL1: 'Sarah Whitfield · Bloom & Branch LLC', cardAddrL2: '412 Larkspur Lane',
      cardAddrL3: 'Lancaster, PA 17601 · United States', cardAddrL4: 'sarah@bloomandbranch.com',
      cardAddrTop: [], cardAddrBottom: [],
      cardHasCountries: true, cardNoCountries: false, cardCountryLabel: 'United States (US)', cardCountryBd: 'var(--rule)',
      ddCardCountryOpen: false, ddToggleCardCountry: () => {}, ddCardCountryOpts: [],
      cardCountryText: '', onCardCountry: () => {},
      cardHasStates: true, cardNoStates: false, cardStateLabel: 'Pennsylvania', cardStateBd: 'var(--rule)',
      ddCardStateOpen: false, ddToggleCardState: () => {}, ddCardStateOpts: [],
      cardStateText: '', onCardState: () => {},
      billAddrMissing: false, billAddrMissingText: '',
  ...
  closeAllDialogs() {
    return {
      ...
      ptoOpen: false, epOpen: false, delOpen: false, rmOpen: false, nsOpen: false, ndOpen: false, naOpen: false,
