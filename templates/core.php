<?php
/**
 * CaptainCore — the current UI (the "v3" ground-up rebuild), served as the
 * DEFAULT template by CaptainCore\Router::load_template(). The old Vue app
...
if ( class_exists( 'user_switching' ) ) {
    ...
    if ( $old_user ) {
        ...
        $cc_boot['switchBackUrl']   = html_entity_decode( add_query_arg( 'redirect_to', urlencode( home_url( $config_path ) ), $switch_back ) );
        $cc_boot['switchBackLabel'] = 'Switch back to ' . $old_user->display_name;
    }
}

$v3_scripts = [ 'app.js', 'data.js', 'router.js', 'toast.js', 'home.js', 'users.js', 'jobs.js', 'processes.js', 'terminal.js', 'site-detail.js', 'addons.js', 'stats.js', 'domains.js', 'accounts.js', 'billing.js', 'security.js', 'reports.js', 'settings.js', 'archives.js', 'profile.js', 'sites-filters.js', 'network.js', 'site-requests.js', 'version-recovery.js', 'registry.js', 'tools.js', 'files.js', 'performance.js' ];
?><!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
