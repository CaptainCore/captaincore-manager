...
Object.assign(Component.prototype, {
  ...
  computeAddAddon(real, s, site) {
    ...
    return {
      ...
      aaUpFg: isUp ? 'var(--ink)' : 'var(--ink-dim)', aaUpBg: isUp ? 'var(--panel-2)' : 'transparent',
      aaWpFg: isWp ? 'var(--ink)' : 'var(--ink-dim)', aaWpBg: isWp ? 'var(--panel-2)' : 'transparent',
      aaEnFg: isEnv ? 'var(--ink)' : 'var(--ink-dim)', aaEnBg: isEnv ? 'var(--panel-2)' : 'transparent',
