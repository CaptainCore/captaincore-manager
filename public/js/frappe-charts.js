var frappe = function() {
    ...
    function b(t, e) {
        ...
        for (var n in e) {
            ...
            if ("inside" === n)
                ...
                "styles" === n ? "object" === (void 0 === a ? "undefined" : Dt(a)) && Object.keys(a).map(function(t) {
                    i.style[t] = a[t]
                }) : ("className" === n && (n = "class"),
    ...
    function T(t) {
        return b("path", {
            ...
            styles: {
                ...
                "stroke-width": arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 0
            }
        })
    }
    function L(t, e, i, n) {
    ...
    function N(t, e, i) {
        ...
        return o.appendChild(b("circle", s)),
        o.appendChild(r),
        o
    }
    function E(t, e, i, n) {
    ...
    function z(t, e, i, n) {
        ...
        return 0 !== r && "0" !== r || (o.style.stroke = "rgba(27, 31, 35, 0.6)"),
        o.appendChild(s),
        o.appendChild(r),
        o
    }
    function W(t, e, i) {
        ...
        return "tick" === n.mode && "right" === n.pos && (a = i + Xt,
        s = i),
        a += n.offset,
        s += n.offset,
        z(t, e, a, s, {
    ...
    function H(t, e, i) {
        ...
        return "tick" === n.mode && "top" === n.pos && (a = -1 * Xt,
        s = 0),
        _(t, e, a, s, {
            stroke: n.stroke,
            className: n.className,
    ...
    function Y(t, e, i) {
        ...
        if (n.regionFill) {
            var u = O(a.svgDefs, i, !0)
              , h = "M" + t[0] + "," + a.zeroLine + "L" + s + "L" + t.slice(-1)[0] + "," + a.zeroLine;
            l.region = T(h, "region-fill", "none", "url(#" + u + ")")
        }
        return l
    }
    function B(t, e, i, n) {
    ...
    function V(t, e, i) {
        return B(t, [i, 0], [e, 0], ne)
    }
    function U(t, e, i) {
        return B(t, [0, i], [0, e], ne)
    }
    function G(t, e, i, n) {
        var a = e - i
          , s = t.childNodes[0];
    ...
    function q(t, e, i, n) {
        var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 0
          ...
          , l = r[1];
        return l -= a,
        "rect" !== t.nodeName ? [[t.childNodes[0], {
            width: n,
            height: o
        }, ee, se], B(t, t.getAttribute("transform").split("(")[1].slice(0, -1), [e, l], ne)] : [[t, {
            width: n,
            height: o,
            x: e,
            y: l
    ...
    function X(t, e, i) {
        return "circle" !== t.nodeName ? [B(t, t.getAttribute("transform").split("(")[1].slice(0, -1), [e, i], ne)] : [[t, {
            cx: e,
            cy: i
        }, ee, se]]
    }
    ...
    function yt(t) {
        function e(t, e) {
            for (var i = gt(t), n = i[1] - i[0], a = 0, s = 1; a < e; s++)
                a += n,
                i.unshift(-1 * a);
            return i
        }
        var i = arguments.length > 1 && void 0 !== arguments[1] && arguments[1]
          , n = Math.max.apply(Math, Wt(t))
          , a = Math.min.apply(Math, Wt(t))
          , s = [];
        if (n >= 0 && a >= 0)
            ft(n)[1],
            s = i ? gt(n, a) : gt(n);
            ...
            var o = Math.abs(a)
              , l = Math.abs(n);
            ft(o)[1],
            s = (s = i ? gt(o, l) : gt(o)).reverse().map(function(t) {
                return -1 * t
            })
        }
        return s
    ...
    function At(t, e) {
        for (var i = Math.max.apply(Math, Wt(t)), n = 1 / (e - 1), a = [], s = 0; s < e; s++) {
            var r = i * (n * s);
            a.push(r)
        }
        return a
    ...
    function Ct(t) {
        ...
        return e.map(function(t, e) {
            return (t += "").length > a && (i ? e % Math.ceil(t.length / a) != 0 && (t = "") : t = a - 3 > 0 ? t.slice(0, a - 3) + " ..." : t.slice(0, a) + ".."),
            t
        })
    }
    function Ot() {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "line"
          , e = arguments[1]
          , i = arguments[2];
        return "axis-mixed" === t ? (i.type = "line",
        new ke(e,i)) : Ae[t] ? new Ae[t](e,i) : void console.error("Undefined chart type: " + t)
    }
    !function(t, e) {
        void 0 === e && (e = {});
        var i = e.insertAt;
    ...
    var Ht = {
      ...
      , Ut = function() {
        ...
        return St(e, [{
            ...
            value: function() {
                ...
                i = this.titleValueFirst ? "<strong>" + this.titleValue + "</strong>" + this.titleName : this.titleName + "<strong>" + this.titleValue + "</strong>",
      ...
      , Zt = {
        bar: function(t) {
            var e = void 0;
            "rect" !== t.nodeName && (e = t.getAttribute("transform"),
            t = t.childNodes[0]);
            var i = t.cloneNode();
            return i.style.fill = "#000000",
            i.style.opacity = "0.4",
        ...
        dot: function(t) {
            var e = void 0;
            "circle" !== t.nodeName && (e = t.getAttribute("transform"),
            t = t.childNodes[0]);
            var i = t.cloneNode()
              , n = t.getAttribute("r")
              , a = t.getAttribute("fill");
            return i.setAttribute("r", parseInt(n) + 4),
      ...
      , te = {
        bar: function(t, e) {
            var i = void 0;
            "rect" !== t.nodeName && (i = t.getAttribute("transform"),
            t = t.childNodes[0]);
        ...
        dot: function(t, e) {
            var i = void 0;
            "circle" !== t.nodeName && (i = t.getAttribute("transform"),
            t = t.childNodes[0]);
            var n = ["cx", "cy"];
            Object.values(t.attributes).filter(function(t) {
                return n.includes(t.name) && t.specified
      ...
      , ue = function() {
        ...
        return St(e, [{
            ...
            value: function(t, e) {
                var i = [];
                return (t = (t || []).concat(Bt[e])).forEach(function(t) {
                    var e = qt(t);
            ...
            value: function() {
                ...
                this.svgDefs = A(this.svg),
                this.title.length && (this.titleEL = E("title", t.margins.left, t.margins.top, this.title, {
                    fontSize: t.titleFontSize,
                    fill: "#666666",
                    dy: t.titleFontSize
                }));
                var e = s(t);
                this.drawArea = P(this.type + "-chart chart-draw-area", "translate(" + r(t) + ", " + e + ")"),
                this.config.showLegend && (e += this.height + t.paddings.bottom,
                this.legendArea = P("chart-legend", "translate(" + r(t) + ", " + e + ")")),
            ...
            value: function() {
                ...
                n.length > 0 ? (tt(this.container, this.svg, n),
                setTimeout(function() {
                    e.forEach(function(t) {
                        return t.make()
                    }),
            ...
            key: "updateNav",
            value: function() {
                this.config.isNavigable && (this.makeOverlay(),
                this.bindUnits())
            }
        }, {
            key: "renderLegend",
            ...
            value: function() {
                var t = this
                  , e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
                this.config.isNavigable && e && (this.bindOverlay(),
                this.keyActions = {
                ...
                document.addEventListener("keydown", function(e) {
                    i(t.container) && (e = e || window.event,
      ...
      , he = function(t) {
        function e(t, i) {
            return Mt(this, e),
            _t(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i))
        }
        return Et(e, t),
        St(e, [{
            key: "configure",
            value: function(t) {
                Nt(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "configure", this).call(this, t),
      ...
      , ge = function() {
        ...
        return St(t, [{
            ...
            value: function() {
                ...
                this.refresh();
                var e = [];
                return t && (e = this.animateElements(this.data) || []),
                e
            }
        }]),
        t
      ...
      , ye = {
        donutSlices: {
            ...
            makeElements: function(t) {
                return t.sliceStrings.map(function(e, i) {
                    var n = T(e, "donut-path", t.colors[i], "none", t.strokeWidth);
                    return n.style.transition = "transform .3s;",
                    n
                })
            },
            animateElements: function(t) {
                return this.store.map(function(e, i) {
                    return K(e, t.sliceStrings[i])
                })
            }
        },
        pieSlices: {
            ...
            makeElements: function(t) {
                return t.sliceStrings.map(function(e, i) {
                    var n = T(e, "pie-path", "none", t.colors[i]);
                    return n.style.transition = "transform .3s;",
                    n
                })
            },
        ...
        yAxis: {
            ...
            makeElements: function(t) {
                ...
                return t.positions.map(function(i, n) {
                    return W(i, t.labels[n], e.constants.width, {
        ...
        yMarkers: {
            ...
            makeElements: function(t) {
                ...
                return t.map(function(t) {
                    return j(t.position, t.label, e.constants.width, {
        ...
        yRegions: {
            ...
            makeElements: function(t) {
                var e = this;
                return t.map(function(t) {
                    return F(t.startPos, t.endPos, e.constants.width, t.label, {
                        labelPos: t.options.labelPos
                    })
                })
            },
        ...
        heatDomain: {
            ...
            makeElements: function(t) {
                ...
                t.cols.map(function(t, i) {
                    1 === i && e.labels.push(E("domain-name", o, -12, ut(n, !0).toUpperCase(), {
                        fontSize: 9
                    })),
                    t.map(function(t, i) {
                        if (t.fill) {
        ...
        barGraph: {
            ...
            makeElements: function(t) {
                ...
                return this.unitType = "bar",
                this.units = t.yPositions.map(function(i, n) {
                    return I(t.xPositions[n], i, t.barWidth, e.color, t.labels[n], n, t.offsets[n], {
                        zeroLine: t.zeroLine,
            ...
            animateElements: function(t) {
                ...
                return this.store.map(function(a, s) {
                    m = m.concat(q(a, e[s], i[s], t.barWidth, n[s], {
                        zeroLine: t.zeroLine
                    }))
                }),
                m
        ...
        lineGraph: {
            ...
            makeElements: function(t) {
                var e = this.constants;
                return this.unitType = "dot",
                this.paths = {},
                e.hideLine || (this.paths = Y(t.xPositions, t.yPositions, e.color, {
                    heatline: e.heatline,
                ...
                this.units = [],
                e.hideDots || (this.units = t.yPositions.map(function(i, n) {
                    return R(t.xPositions[n], i, t.radius, e.color, e.valuesOverPoints ? t.values[n] : "", n)
                })),
            ...
            animateElements: function(t) {
                ...
                var p = [];
                return Object.keys(this.paths).length && (p = p.concat(J(this.paths, e, i, t.zeroLine))),
                this.units.length && this.units.map(function(t, n) {
                    p = p.concat(X(t, e[n], i[n]))
                }),
                p
            }
        }
      ...
      , me = function(t) {
        function i(t, e) {
            Mt(this, i);
            var n = _t(this, (i.__proto__ || Object.getPrototypeOf(i)).call(this, t, e));
            return n.type = "percentage",
            n.setup(),
            n
        }
        return Et(i, t),
        St(i, [{
            ...
            value: function(t) {
                ...
                e.paddings.right = 30,
                e.legendHeight = 80,
                e.baseHeight = 8 * (i.height + .5 * i.depth)
            }
        }, {
            key: "setupComponents",
            value: function() {
      ...
      , be = function(t) {
        ...
        St(i, [{
            key: "configure",
            value: function(t) {
                Nt(i.prototype.__proto__ || Object.getPrototypeOf(i.prototype), "configure", this).call(this, t),
                this.mouseMove = this.mouseMove.bind(this),
                this.mouseLeave = this.mouseLeave.bind(this),
                this.hoverRadio = t.hoverRadio || .1,
            ...
            value: function() {
                ...
                e.sliceTotals.map(function(i, o) {
                    ...
                    var c = a ? -u : u
                      ...
                      , y = void 0
                      , m = void 0;
                    t.init ? (y = g ? g.startPosition : f,
                    m = g ? g.endPosition : f) : (y = f,
                    m = v);
                    var b = L(y, m, t.center, t.radius, a, h);
            ...
            value: function(t, i, n, a) {
                if (t) {
                    var s = this.colors[i];
                    if (n) {
                        Q(t, this.calTranslateByAngle(this.state.slicesProperties[i])),
                        t.style.fill = g(s, 50);
                        var r = e(this.svg)
                          , o = a.pageX - r.left + 10
                          , l = a.pageY - r.top - 10
      ...
      , xe = function(t) {
        function e(t, i) {
            Mt(this, e);
            var n = _t(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i));
            n.type = "heatmap",
            n.countLabel = i.countLabel || "";
            var a = ["Sunday", "Monday"]
              , s = a.includes(i.startSubDomain) ? i.startSubDomain : "Sunday";
            return n.startSubDomainIndex = a.indexOf(s),
            n.setup(),
            n
        }
        return Et(e, t),
        St(e, [{
            ...
            value: function(t) {
                ...
                e.paddings.bottom = 0,
                e.legendHeight = 24,
                e.baseHeight = 12 * ce + o(e);
                var i = this.data
                  , n = this.discreteDomains ? 12 : 0;
                this.independentWidth = 12 * (rt(i.start, i.end) + n) + l(e)
            }
        }, {
            key: "updateWidth",
            value: function() {
            ...
            value: function() {
                var t = this.state;
                t.start = st(this.data.start),
                t.end = st(this.data.end),
                t.firstWeekStart = st(t.start),
                t.noOfWeeks = rt(t.start, t.end),
                t.distribution = At(Object.values(this.data.dataPoints), 5),
            ...
            value: function() {
                ...
                this.colors.slice(0, 5).map(function(i, n) {
                    var a = M("heatmap-legend-unit", e + 15 * n, 12, 10, i);
            ...
            key: "getDomains",
            value: function() {
                for (var t = this.state, e = [t.start.getMonth(), t.start.getFullYear()], i = e[0], n = e[1], a = [t.end.getMonth(), t.end.getFullYear()], s = a[0] - i + 1 + 12 * (a[1] - n), r = [], o = st(t.start), l = 0; l < s; l++) {
                    var u = t.end;
                    if (!lt(o, t.end)) {
                        var h = [o.getMonth(), o.getFullYear()];
                        u = ht(h[0], h[1])
                    }
                    r.push(this.getDomainConfig(o, u)),
                    dt(u, 1),
                    o = u
                }
                return r
            ...
            value: function(t) {
                ...
                dt(e = st(e) || ht(n, a), 1);
                for (var o = rt(s, e), l = [], u = void 0, h = 0; h < o; h++)
                    u = this.getCol(s, n),
                    l.push(u),
                    dt(s = new Date(u[ce - 1].yyyyMmDd), 1);
                return void 0 !== u[ce - 1].dataValue && (dt(s, 1),
                l.push(this.getCol(s, n, !0))),
                r.cols = l,
                r
            }
        }, {
            key: "getCol",
            value: function(t, e) {
                for (var i = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], n = this.state, a = st(t), s = [], r = 0; r < ce; r++,
                dt(a, 1)) {
                    var o = {}
                      , l = a >= n.start && a <= n.end;
                    i || a.getMonth() !== e || !l ? o.yyyyMmDd = at(a) : o = this.getSubDomainConfig(a),
                    s.push(o)
                }
                return s
            }
            ...
            value: function(t) {
                ...
                return {
                    yyyyMmDd: e,
                    dataValue: i || 0,
                    fill: this.colors[Pt(i, this.state.distribution)]
                }
            }
        }]),
        e
      ...
      , ke = function(t) {
        function i(t, e) {
            Mt(this, i);
            var n = _t(this, (i.__proto__ || Object.getPrototypeOf(i)).call(this, t, e));
            return n.barOptions = e.barOptions || {},
        ...
        St(i, [{
            key: "setMeasures",
            value: function() {
                this.data.datasets.length <= 1 && (this.config.showLegend = 0,
            ...
            key: "prepareData",
            value: function() {
                return Tt(arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.data, this.type)
            }
        }, {
            key: "prepareFirstData",
            value: function() {
                return Lt(arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.data)
            }
        }, {
            key: "calc",
            value: function() {
            ...
            value: function(t) {
                var e = yt(t, arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "false")
                  , i = this.height / xt(e)
                  , n = bt(e) * i
                  , a = this.height - mt(e) * n;
                this.state.yAxis = {
                    labels: e,
            ...
            value: function() {
                ...
                this.data.yMarkers && (this.state.yMarkers = this.data.yMarkers.map(function(e) {
                    return e.position = kt(e.value, t.yAxis),
                    e.options || (e.options = {}),
                    e
                })),
                this.data.yRegions && (this.state.yRegions = this.data.yRegions.map(function(e) {
                    return e.startPos = kt(e.start, t.yAxis),
                    e.endPos = kt(e.end, t.yAxis),
                    e.options || (e.options = {}),
                    e
                }))
            }
            ...
            value: function() {
                ...
                .bind(this)], ["xAxis", {
                    ...
                    var t = this.state;
                    return t.xAxis.calcLabels = Ct(this.width, t.xAxis.labels, this.config.xIsSeries),
                    t.xAxis
                }
                .bind(this)], ["yRegions", {
                    width: this.width,
                ...
                this.components = new Map(e.filter(function(e) {
                    return !o.includes(e[0]) || t.state[e[0]]
                }).map(function(e) {
                    var i = pt.apply(void 0, Wt(e));
                    return (e[0].includes("lineGraph") || e[0].includes("barGraph")) && t.dataUnitComponents.push(i),
                    [e[0], i]
                }))
            }
        }, {
            ...
            value: function(t) {
                var e = this.state;
                if (e.yExtremes) {
                    var i = wt(t, e.xAxis.positions, !0)
            ...
            value: function() {
                var t = this
                  , e = this.data;
                e.datasets.length > 1 && (this.legendArea.textContent = "",
                e.datasets.map(function(e, i) {
                    var n = S(100 * i, "0", 100, t.colors[i], e.name);
            ...
            value: function(t) {
                ...
                t !== e.currentIndex && (e.currentIndex = t,
            ...
            value: function(t, e) {
                ...
                Nt(i.prototype.__proto__ || Object.getPrototypeOf(i.prototype), "addDataPoint", this).call(this, t, e, n),
            ...
            value: function() {
                ...
                this.data.labels.length <= 1 || (Nt(i.prototype.__proto__ || Object.getPrototypeOf(i.prototype), "removeDataPoint", this).call(this, t),
            ...
            value: function() {
                ...
                e.sliceTotals.map(function(i, o) {
                    var l = r
                      ...
                      , g = void 0
                      , y = void 0;
                    t.init ? (g = v ? v.startPosition : p,
                    y = v ? v.endPosition : p) : (g = p,
                    y = f);
                    var m = C(g, y, t.center, t.radius, t.clockWise);
                    e.sliceStrings.push(m),
                    e.slicesProperties.push({
                        startPosition: p,
                        endPosition: f,
                        value: i,
      ...
      , Le = {};
    return Le.NAME = "Frappe Charts",
    Le.VERSION = "1.1.0",
    Le = Object.assign({}, Le, Te)
}();
